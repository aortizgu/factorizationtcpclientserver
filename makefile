...
factorization_client: factorization_client.c common.c messageprocessor.c clientconnection.c
	gcc factorization_client.c common.c messageprocessor.c clientconnection.c -o factorization_client -I.
